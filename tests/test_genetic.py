...
class TestBasicOptimiser(unittest.TestCase):
	...
	def test_optimiser(self):
		...
		opt = BasicOptimiser(loss_fn, 10000, genome_shape=(2, 2), lower_bound=1, upper_bound=4)
		solution = opt.optimise([], [], "mse", child_max_loss=0.1, mutation_rate=1, mutation_magnitude=10, fill_value=2)
		print(solution)
